...
** */
    ...
    let word = generateWord();      // get a random word
    ...
    /** function that generates a random index to get a random word **/
    function generateWord(){
        let wordIndex = Math.floor(Math.random() * (449 + 1));  // generating random number
        console.log(wordIndex);
        let word = words[wordIndex];                                    // select word based on the number
        console.log(word);
        return word;
    }
    ...
    function restGameBoard(){
        ...
        row = 0;
        gameOver= false;
        word = generateWord();                                   // pickup a new word
